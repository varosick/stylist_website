...
from users.views import UserLoginView, UserProfileView, UserRegistrationView, UsersReviewsView, user_logout, \
    UserServicesView, UserServiceDetailView, UserGuidesView, UserGuideDetailView, EmailVerificationView, \
